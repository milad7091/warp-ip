...
:main
cls
title WARP Endpoint IP - Youtube:Misahiro
echo ############################################################
echo #                WARP Endpoint IP - Youtube:Misahiro       #
echo # Like and Subscribe                                       #
echo # GitHub  : https://github.com/milad7091                   #
echo # YouTube : https://www.youtube.com/@Misahiro              #
echo ############################################################
echo.
echo 1. WARP IPv4 Endpoint IP 
echo 2. WARP IPv6 Endpoint IP 
echo.
choice /c 120 /M "Select[1,2,3]:"
if "%errorlevel%"=="3" exit
if "%errorlevel%"=="2" set ver=v6
if "%errorlevel%"=="1" set ver=v4
title WARP IP%ver% Endpoint IP Selected
